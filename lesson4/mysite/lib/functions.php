...
function renderNavMenu()
{
    ...
    foreach ($NAVMENU as $menuitem => $menuaction) {
        $navMenu .= '<li><a href="?route=' . $menuaction . '">' . $menuitem .'</a></li>';
    };
    $navMenu .= "</ul>";
    return $navMenu;
}
...
/* Функция формирования контента из файла-шаблона с параметрами
*  @param $file
...
*  @return string
*/
function layout($layoutName, $title, $style, $menu, $body)
{
